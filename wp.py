...
print('''
        ...
        <!--- Mass Upload Shell WP File Manager --> 
         \033[0m                                             
          .------------------------.
          |  \033[41m\033[1;33mCoded By ZakirDotID\033[0m   |
          '------------------------'
              ^      (\_/)
              '----- (\033[1;31mO.o\033[0m)
                     (> <)      
